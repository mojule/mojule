...
describe( 'Node', () => {
  ...
  it( 'append moves child', () => {
    ...
    const parent1 = Node( 'parent 1' )
    const parent2 = Node( 'parent 2' )
  ...
  it( 'extends', () => {
    const extend = ( api, nodeValue, tree, valueSymbol ) => {
      api.secondChild = () => api.firstChild.nextSibling
    }

    const Node2 = value => Node( value, { extend } )
